...
output "authentication_certificate_id" {
  ...
  value       = [for k in azurerm_application_gateway.agw.authentication_certificate : k.id] #azurerm_application_gateway.main.authentication_certificate.*.id
}
...
output "request_routing_rule_backend_http_settings_id" {
  ...
  value       = azurerm_application_gateway.agw.request_routing_rule.*.backend_http_settings_id
}
...
output "request_routing_rule_redirect_configuration_id" {
  ...
  value       = azurerm_application_gateway.agw.request_routing_rule.*.redirect_configuration_id
}
...
output "request_routing_rule_rewrite_rule_set_id" {
  ...
  value       = azurerm_application_gateway.agw.request_routing_rule.*.rewrite_rule_set_id
}

output "request_routing_rule_url_path_map_id" {
  description = "The ID of the Request Routing Rule associated URL Path Map"
  value       = azurerm_application_gateway.agw.request_routing_rule.*.url_path_map_id
}

output "ssl_certificate_id" {
  description = "The ID of the SSL Certificate"
  value       = azurerm_application_gateway.agw.ssl_certificate.*.id
}

output "ssl_certificate_public_cert_data" {
  description = "The Public Certificate Data associated with the SSL Certificate"
  value       = azurerm_application_gateway.agw.ssl_certificate.*.public_cert_data
}

output "url_path_map_id" {
  description = "The ID of the URL Path Map"
  value       = [for k in azurerm_application_gateway.agw.url_path_map : k.id]
}
...
output "url_path_map_default_backend_address_pool_id" {
  ...
  value       = [for k in azurerm_application_gateway.agw.url_path_map : k.default_backend_address_pool_id]
}
...
output "url_path_map_default_backend_http_settings_id" {
  ...
  value       = [for k in azurerm_application_gateway.agw.url_path_map : k.default_backend_http_settings_id]
}
...
output "url_path_map_default_redirect_configuration_id" {
  ...
  value       = [for k in azurerm_application_gateway.agw.url_path_map : k.default_redirect_configuration_id]
}

output "custom_error_configuration_id" {
  description = "The ID of the Custom Error Configuration"
  value       = azurerm_application_gateway.agw.custom_error_configuration.*.id
}
...
output "rewrite_rule_set_id" {
  ...
  value       = azurerm_application_gateway.agw.rewrite_rule_set.*.id
}